            ...
            <div className="flex flex-col sm:flex-row gap-5 sm:items-start items-center  justify-between  ">
                ...
                <div className="flex gap-10">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-2">
                            <a target="_blank" className="cursor-pointer hover:text-secondary transition duration-150" href="https://www.instagram.com/luchonromero_/">Instagram</a>
                            <a target="_blank" className="cursor-pointer hover:text-secondary transition duration-150" href="https://www.linkedin.com/in/lucianoromerosilva/">Linkedin</a>
                            <a target="_blank" className="cursor-pointer hover:text-secondary transition duration-150" href="https://github.com/Luchoromero29">Github</a>
                        </div>
                    </div>
                </div>
            </div>
