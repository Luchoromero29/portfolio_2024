...
const ItemProject = ({ project }) => {
    ...
    return (
        <div className="dark:text-white p-4 border-2 rounded-lg border-dark-secondary">
            <header>
                <Typography variant="title-project">{title}</Typography>
            </header>
            <main className="flex flex-col sm:flex-row sm:gap-5 gap-5 relative min-h-[440px]">
                ...
                <div className="flex-grow items-center justify-center relative w-full">
                            ...
                            <img
                                ...
                                className={`${
                                    project.platform === "desktop"
                                        ...
                                        : "h-[400px]"
                                } top-0 absolute w-auto object-contain transform transition-all duration-700 ease-in-out ${
                                    index === activeIndex
