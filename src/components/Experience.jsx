      ...
      <main className="flex flex-col">
        <section className="flex justify-center items-center flex-col px-8 sm:hidden">
          <div className="flex items-center justify-start w-full">
            <div
              className={`w-1  h-6 line-education-color line-education-color`}
            ></div>
          </div>
          <div
            className={`h-1 w-full  rounded-bl-md rounded-tr-md line-education-color line-education-color`}
          ></div>
        ...
        <section className="flex   gap-8 relative">
          <div className="flex sm:w-[45%] flex-col gap-4">
            <ItemExperience
              title={t("education.terralajas.title")}
              description={t("education.terralajas.description")}
              institution={t("education.terralajas.institution")}
            />
            <ItemExperience
              title={t("education.cenumen.title")}
              description={t("education.cenumen.description")}
              institution={t("education.cenumen.institution")}
            />
          </div>
          <div className="">
            <div className=" line-education-color line-education ">
              <div className="container-date-ball">
                <div className="date-ball">
                  <Typography variant="span">2025</Typography>
                </div>
              </div>
            </div>
          </div>
          <div className="flex  sm:w-[45%]"></div>
        </section>
        <section className="flex justify-center items-center flex-col px-8 sm:hidden">
          <div className="flex items-center justify-end w-full">
            <div
          ...
          <div
            className={`h-1 w-full rounded-tl-md rounded-br-md line-education-color line-education-color`}
          ></div>
          <div className="flex items-center justify-start w-full">
            <div
              className={`w-1  h-6 line-education-color line-education-color`}
